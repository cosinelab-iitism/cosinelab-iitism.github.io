...
export const ongoingProjects = [
  {
    ...
    sponsor: "Jharkhand Council on Science, Technology and Innovation (JCSTI)",
    image: jcsti,
  },
  {
    ...
    sponsor: "NMICPS TiHAN-IIT Hyderabad",
    image: tihan,
  },
  {
    ...
    sponsor: "IIT (ISM) Dhanbad (Special Collaborative Grant)",
    image: cosineBg,
  },
  {
    ...
    sponsor: "IIT (ISM) Dhanbad (Seed Grant / FRS)",
    image: cosineBg,
  },
  {
    ...
    sponsor: "TEXMiN Foundation (DST TIH)",
    image: texmin,
  },
...
export const completedProjects = [
  {
    ...
    sponsor: "IIT (ISM) Dhanbad (Special Grant)",
    image: cosineBg,
  },
].map((p) => ({ ...p, slug: slugify(p.title) }));
